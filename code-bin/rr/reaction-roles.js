const messageSchema = require('@models/reaction-role-schema')
        ...
        for (const key of Object.keys(roles)) {
            if (key === toCompare) {
                ...
                if (role) {
                    ...
                    if (adding) { member.roles.add(role) }
...
module.exports = async (client) => {
    ...
    console.log(`WOKCommands > Feature "reaction-roles" is set up.`);
}
...
module.exports.config = {
    displayName: 'Reaction role handler',
